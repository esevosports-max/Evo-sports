            ...
            <div>
              ...
              <div className="mt-2 relative flex items-center">
                <input
                  ...
                  className="block w-full rounded-xl border border-emerald-200 bg-white pl-4 pr-11 py-3 text-sm text-zinc-900 shadow-inner outline-none transition-all duration-200 focus:border-emerald-500 focus:bg-white focus:ring-1 focus:ring-emerald-500 dark:border-emerald-800 dark:bg-white dark:text-zinc-900 dark:focus:border-emerald-400 dark:focus:bg-white"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 p-1.5 rounded-lg text-zinc-400 hover:text-zinc-650 dark:hover:text-zinc-300 transition-colors focus:outline-none cursor-pointer flex items-center justify-center"
